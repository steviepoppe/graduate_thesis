...
Finally, it should be mentioned that any research involving the Internet and social networks online is bound to have some limitations. In this case limitations involve liquidity of data, copyright laws pertaining acquiring data and lack of reliability due anonymity blocking full intent of the author. Other issues are the extraction of online data from an ethical viewpoint and the concept of informed consent. The dataset contains data created independent of the researcher (what *Doing Qualitative Research Online* author Janet Salmon 2016 describes an extant method), on platforms that are either explicitly open (Youtube, 2channel, Reddit, *matome* blogs) or that is publicly accessible once logged in with a profile (Twitter, public figures on Facebook, Niconico), data that is openly available to group-outsiders and explicitly intended to be so, including user-names, on online spaces that are not expected to be private spaces. Following Janet Salmons argument for a synthesis between different traditions on research ethics, it is therefore reasonable to argue that informed consent is not applicable in this case.
...
multi-disciplinary approach to CDA

(btw googletrends van interesse in nettouyoku en alt-right samen, en appart)
...
(nog iets over ideological polarization)

\newpage

#Chapter One: Media, Ideology, Populism and Japan - Connecting the Dots
...
Eerst nog schrijven over power.

"1. A system of ideas and ideals, especially one which forms the basis of economic or political theory and policy. 2. The set of beliefs characteristic of a social group or individual", thus defines the Oxford Dictionary ideology.[^36] Although @eagleton_ideology:_1991 in his approach to ideology critique agrees that such a view on the notion of ideology is common in public discourse (albeit with the possibility of an underlying critique by those who use the term: that the ideologue has an 'an oversimplifying view of the world' and through doctrine has a distorted understanding of reality), he does warn against, in light of the historical context briefly sketched below, one 'Grand Global Theory' or one single comprehensive definition of ideology, especially one that would contrast ideology with pragmatism. Following Martin Heidegger's hermeneutic reasoning of interpreting reality for example, it would be impossible to identify and judge an occurrence without a set of preconceived values [-@eagleton_ideology:_1991: p.1, pp221-224]. 

The conceptualizing of ideology has known many approaches. Historically, the concept finds its roots in the French Revolution, in a positivist attempt to develop a new scientific framework of Enlightenment ideas ('the discourse of patterns'), a skeptical scientific materialism [@eagleton_ideology:_1991: p.70], before going through several shifts in meaning following Napoleon's attack of the French "ideologues" as what @mudde_oxford_2013 describe as being "unrealistic escapism and philosophical reverie". From a critical Marxist view, as interpreted by @eagleton_ideology:_1991, ideology too represented a false or misleading awareness on the human situation (false consciousness), but ideology was rather to be understood as an instrument of those in control of the means of production, the dominant class, to steer (whether intentional or not) the economically subservient class away from the objective reality, and thus their best interests, with a "false consciousness" or "common sense" (such as the economic miracle and the *nihonjinron* 日本人論 brand of nationalism during the 80's), legitimizing the *status quo* of society and its economic structures of exploitation.[^37] In other words, traditional Marxist theory places ideology as a superstructure in contrast to reality within an economic, dialectic basis-superstructure relationship, and the dominant ideology is therefore directly tied to the means of production (such as the function of Confucianism and state-shintoism for example, to morally justify exploitation in respectively the feudal Tokugawa state and military dictatorship of the Japanese empire, in comparison to 'commodity fetishism' in a capitalist society **NOTE: but what about nationalism? also**) and visa-versa.[^38] 

With the idea of a 'positive' ideology to counter class oppression, and the Marxist interpretation of history becoming to be seen as ideology itself, so too changed the pejorative notion of ideology. Within the birth of sociology as an academic field, Karl Mannheim approached ideology as dynamic and being shaped both by unconscious assumptions guiding our lives on a *psychological* level, and by our (social group's) position within social structures, on a *social* level. Analyzing a worldview as an ideology is paradoxically achieved only from the vantage point of another ideology, as implied earlier with Heidegger's reasoning [@van_dijk_politics_2006;@mudde_oxford_2013: ch.1,ch.3]. Since then, and with sociological developments such as liguistic turn, ideology as a concept has seen a wide range of meanings, deeply entangled with the study of discourse, *power* and politics [@mudde_oxford_2013: ch.1], with contributions to ideology theory made by amongst others Marxist scholars Georg Lukács (theory of reification) and Antonio Gramsci (theory of hegemony), the Frankfurt School, schools of Critical Discourse Analysis, Foucault and Althusser. Based on Eagleton's six different ways of defining ideology [@eagleton_ideology:_1991, pp.28-30; @fuchs_racism_2018, pp.158-159], let us first observe the following list:

1. Ideology as the "production of ideas, beliefs and values in social life" and "the way individuals 'lived' their social practices. rather than to those practices themselves" (ideology as culture). The social deterministic relation between the whole complex of signifying practices and symbolic processes in a particular society, and political power.
2. Ideology as ideas and beliefs of a "specific, socially significant group or class" (ideology as worldview), "a kind of collective symbolic self-expression".
3. The "*promotion* and *legitimation* of the interests" of groups "in the face of opposing interests" (ideology as rhetorical discourse, a "discursive field in which self-promoting social powers conflict and collide over questions central to the reproduction of social power as a whole").
4. The "*promotion* and *legitimation* of sectoral interests" by a "a dominant social power", to unify a convenient social formation in ways convenient for
its rulers" and secure "the complicity of subordinated classes and groups" (ideology as dominant worldviews).
5. Like 4, "ideas and beliefs which help to legitimate the interests of a ruling group or class" but specifically through "distortion and dissimulation".
6. False or deceptive beliefs[^39] "arising not from the interests of a dominant class but from the material structure of society as a whole", such as Marx's theory of commodity fetishism.

The epistemologically neutral definitions we've seen courtesy of the Oxford Dictionary fit the first two descriptions given in the above list. In the last two, we find Gramsci, Lukács and Althusser, three crucial thinkers in expanding Marxist theory on ideology. Building on the concept of false consciousness, and within the context of an increasing economical class awareness in the 19th century, Lukács theorized class consciousness as class-bound ideology through class-level self-awareness, the result of alienation of the self and a fragmented understanding of society and life (or rather, totality) in wake of Marx's notion of commodity fetishism [@eagleton_ideology:_1991, pp.94-99]. After the failure to bring communist revolution in Italy, Gramsci recognized culture (or cultural *soft* power) as missing link in traditional Marxist theory. Gramsci expands this by viewing consent to the rule of the governing class as the result of processes of socialization and the promulgation of ideology through social institutions within the public sphere of "civil society", a concept he coined cultural hegemony. He went beyond Marx's economic class by introducing social and cultural classes, and coined the concept of *subaltern* (a term crucial in post-colonial studies)[^40] to refer to those classes subjected to that cultural hegemony; who's history is overshadowed by that of the ruling class. For revolution to be successful, it is therefore first necessary for those classes to dismantle the cultural hegemony by develop their own ideology as class-consciousness and counter-hegemony.[^41] Coercion to the rule of the governing class by physical means, in contrast, is restricted to the level of "political society". In a modern capitalist state however, civil society and *soft* power have grown to such an extent that this "legitimized violence" has to certain degrees respond to public consent.

If Gramsci were to be alive today then, would he view the Internet and social media as the means to achieve this? The online culture wars I described in this paper's introduction (such as Gamergate) certainly seems to suggest so. Online *influencers* use (semi-)public platforms to spread politically inspired messages on Youtube, Niconico, Twitter, Instagram and Facebook, and right-wing populists utilize this medium to sell a narrative of revolution.

Perry Anderson[^43] builds on this. Whereas gramsci locates cultural hegemony in civil society alone, Anderson finds hegemony in political society, "for the political form of the capitalist state is itself a vital organ of such power" [@eagleton_ideology:_1991, pp.112-113].[^42]
...
In Edward Samuel Herman and Noam Chompsky's work on propaganda in mass media, *Manufacturing Consent: The Political Economy of the Mass Media*
...
Important in furthering traditional Marxist theory are Gramsci and Lukács.  

who coined the concept of cultural hegemony, views ideology as a means to gain consent by the ruling classes and incorporates the concept of social class  

Chomsky -> manufacturing consent

 views ideologies as worldviews (the "superstructure of a particular structure").
...
[^5]: A conservative Nippon Foundation platform *nippon.com* English-language publication by author Furuya Tsunehiro (a cultural critic, online personality and until 2014 a frequent guest on Channel Sakurai) claims that "disturbing as the voice of cyber-extremism may be, its influence on Japanese politics and society remains limited, and its heyday is nearing an end" [@furuya_roots_2016].
