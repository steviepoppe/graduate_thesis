...
een adequate Habermasiaanse `openbare sfeer' waarin contra-hegemonische
ideologieën kunnen verspreid worden.
\newline
...
de LDP en specifiek premier Abe Shinzō (iemand die in elke zin het
politiek establishment beademt) aanschouwd? Daarvoor stellen we dat de
LDP en Abe Shinzō in de nasleep van de aardbeving en kernramp in 2011 de
huidige golf aan rechts-populisme voorliepen. Concreet stellen we dat:
1. de huidige instantie van de LDP succesvol inspeelde op die golf aan
cyber-nationalisme, door het medium van het internet en dier dichotome
relatie met massamedia te omhelzen, en 2. de ideologische hegemonie
verspreidde via de door de staat gesponsorde cultuurindustrie (in de
vorm van de `Cool Japan' soft-power) en aldus ook de Japanse
...
本稿の目的は、日本における「ネット右翼」の背景に隠される「論理」を明らかにすること。米国での2016年の大統領選挙およびイギリスの欧州連合離脱（いわゆる「ブレグジット」）に関する国民投票の予想外の結果以来、新ナショナリズム（ネオ・ナショナリズム）\footnote{言い換えれば、右派ポピュリズト的で、排外主義的なナショナリズムである。}
の世界的な成長とその中のインターネットの影響に関する学術研究の増加がある。この研究の一部は、インターネット利用者の右傾化に関し、特に多くの政治的プロパガンダが追跡されているいくつかの「オンラインコミュニティ」に集中している。そのプロパガンダとは、著名な政治家を含む、FacebookやTwitterなどで大量に普及されている現象が明らかにする
(Zannettou et al. \protect\hyperlink{ref-zannettou_origins_2018}{2018})
。日本でも、こういう傾向が見え、例としてシェーファーは２０１４年総選挙の際、Twitterで選挙に関する「ツイート」の中で多量の、bot\footnote{botとはこの文脈で自動アルゴリズムを示しているものである。}
により普及されている右翼的あるいは自由民主党を支持している「ツイート」がある可能性を指摘している
(\protect\hyperlink{ref-schafer_japans_2017}{2017})
。その現象を示すため、それぞれの国の言語で「オルタナ右翼」（alt-right）、「fachosphère」または「ネット右翼」（いわゆるネトウヨ）という用語が主流となっている。

第一章（序章）は、そのインターネットにおける右傾化（本稿では、新ナショナリズム）を「サイバーナショナリズム」と概念し、「オルタナ右翼」や「ネット右翼」などの用語は、本現象を示す地域的な表現として扱っている。そして、「サイバーナショナリズム」とは、ただインターネットにおける「新ナショナリズム」だけではなく、インターネットのそのメディア自体のイデオロギー（いわゆる、マスメディアと対比する新しいメディアの理屈）によっても形作られている。世界中でサイバネーショニズムが右翼ポピュリスト政治的新人の支援に結びついている上に、在特会\footnote{「在日特権を許さない市民の会」の省略。桜井誠に設立され、主に在日韓国・朝鮮人を中心にする自称市民団体である。反差別機関に多く批判され、平成２９年に最高裁判所でヘートスピーチとされる言葉に関する損害賠償が確定された。}
を含むいわゆる保守行動運動のさまざまな新ナショナリストの市民運動が存在し、「ネット右翼」というその言葉自体が日本第一党などの反体制派の右翼ポピュリストのために適切な有権者の存在を意味している。しかしながら、それにもかかわらず「ネット右翼」は自由民主党を指示している傾向が多く見える。本稿の概説は、２０１６年を特に、世界中に右翼ポピュリスト新参者が、サイバーナショナリストによって感じられる既成の政治制度、左翼機関または主流メディアへの不信を利用している一方で、自民党は２０１１年の地震をきっかけに2012年の選挙でそれをより早く達成した。具体的に本稿は二つの概説を提案する：１．現在の自民党はインターネットメディア（SNS）とその上に感じられるマスメディアへの対立を利用し、日本におけるサイバーナショナリストに訴えかけている。２.さらに、ドイツ派のアドルノとホルクハイマーの理論を通じると、自民党が文化産業（Culture
Industry）の「ソフトパワー」を通じて広めたヘゲモニー的イデオロギーは、日本におけるサイバーナショナリストの思想形成における一つのアプローチである。

第二章は、ネット右翼についての文学研究である。ネット右翼に関する論文の多くには大幅に三つの傾向が見える。１．Twitterや文学でよくネット右翼と関連される「2ちゃんねる」\footnote{２ちゃんねるとは平成11年西村博之により開設された匿名な電子掲示板である。平成２９年してから「5ちゃんねる」に名付けられたにも関わず、以前の文献とのつながりのため、本稿は「２ちゃんねる」の名を利用し続ける。}などののソーシャルメディア上でのネット右翼の修辞的思考過程の分析(辻，
...
高，
\protect\hyperlink{ref-taka_twitter_2015-1}{2015}\protect\hyperlink{ref-taka_twitter_2015-1}{b})。２．ネット右翼と在特会を含む新ナショナリストの市民運動の関係(安田，
...
\protect\hyperlink{ref-gill_nativist_2018}{2018})のような新民族主義者グループとの関係。３．ネット右翼の出現に対する理論的アプローチ(東，
...
\protect\hyperlink{ref-murai_net_2012}{2012})。辻大介は大幅に3つの主な特徴でネット右翼を定義します(\protect\hyperlink{ref-tsuji_eng:_2008}{2008};
...
\item
  主に中国と韓国に対する排外主義的な理想
\item
  憲法改正や靖国神社への公式参拝などへの国家主義的な支持
\item
  SNSなどインターネットで自分の政治的な意見を投稿すること
\end{itemize}

2008年の調査によると、参加している関係者の約1％がその三つの要件を満たし、2014年のその調査の繰り返しでは、それは2％である。
辻はまた、潜在的なネット右翼行動（すなわち、投稿せず残りへの賛成）の増加を主張した。最後に、彼はニコニコと２ちゃんねるの使用と、匿名SNS（FacebookよりTwitter）の好みの間に相関関係を示した。本稿は、その特徴に「マスメディアへの不信」お付け加える。北田暁大(\protect\hyperlink{ref-kitada_eng:_2005}{2005})は２ちゃんねるなどの匿名な電子掲示板を「皮肉の共同体」と名付け、その電子掲示板における右傾化が「つながりの社会性」の結果の一つであるとを提案した。要するに、インターネットへのコミュニケーション環境の変更以降、「内輪」で感じられる連帯感のためコミュニケーション自体が目的になり、2ちゃんねるでは、インターネット空間の対照とするマスメディアをアイロニー的な批判するコミュニケーションで共同体ができる。

サカモト・ルミ(\protect\hyperlink{ref-sakamoto_koreans_2011}{2011})と村井秀輔(\protect\hyperlink{ref-murai_net_2012}{2012})は2ちゃんねるとニコニコの上のネット右翼の投稿の構造を分析します。彼らまた、アンダーソン(Anderson
\protect\hyperlink{ref-anderson_imagined_2006}{2006})に頼り、北田も指摘したように、2ちゃんねるのような匿名のSNSでは、インターネットスラングを含む書き込みの書き方により、「想像の共同体」が建てられたことを対案した。高史明(\protect\hyperlink{ref-taka_twitter_2015}{2015}\protect\hyperlink{ref-taka_twitter_2015}{a};
\protect\hyperlink{ref-taka_twitter_2015-1}{2015}\protect\hyperlink{ref-taka_twitter_2015-1}{b})は、Twitter
における中国人と「コリアン」についての日本語のツイートを収集し、計量的な分析では、多くのツイートはネガティブであり、少数のユーザーにより投稿をし、２ちゃんねるや「２ちゃんねるまとめブログ」の強い影響力があることを示した。

安田浩一(\protect\hyperlink{ref-yasuda_eng:_2012}{2012})、山口智美(\protect\hyperlink{ref-yamaguchi_xenophobia_2013}{2013})と樋口直人(\protect\hyperlink{ref-higuchi_japans_2014}{2014})はまた、ネット右翼を主に在特会のような新ナショナリストの市民運動のグループとを関連付ける。これらのグループは、いわゆる「右翼団体」を特徴づける超ナショナリズムとは一線を画し、目標としてしばしば外国人、グローバリズム、マスコミと左翼政治家をターゲットする傾向が多い。それらの団体は、抗議行動のビデオをインターネットを投稿したり、２ちゃんねるやニコニコなどのSNSを利用しながら、自分のメッセージを普及しているものの、在特会の桜井誠自身がそのサイバー空間上での右派の過激化の結果であるとも言える。在特会をはじめ、新ナショナリストの市民運動は２０１４年以降急激に減りつつあるからといって、ネット右翼的な感情も低下するものではない。実のところ、自民党により朝日新聞やNHKなどのマスメディアへの攻撃やニコニコの使用が増えることから、安倍晋三のFacebookに投稿されたメッセージでインターネットを草の根のツールとして明示的に言及したりすることに至るまで自民党とネット右翼の間の重複が増えていくのだからには、在特会のような団体の必要性が漸減することではあるまいか。

第三章は、背景に隠されるサイバーナショナリズムの論理を明らかにするために、西ドイツのフランクフルト学派のイデオロギーへの理論的アプローチを基礎にする。右翼ポピュリストのレトリックを解釈すると、グラムシの論理的な風潮が明らかにされる。すなわち、既成の政治制度、左翼機関またはマスコミが果たしている役割とは「エリート」のヘゲモニー的イデオロギーに対して、道具的に「庶民」の同意を製造するものである。その上、そのヘゲモニー的イデオロギーは（自己認識の）社会における「矛盾」から逸脱され、「庶民」または「世論」を十分に代表していない。従って、ハーバーマスの公共圏（public
sphere）と解釈されているインターネットは、カウンター（反覇権的）イデオロギーの創造と普及に好適だと思われる。インターネットをめぐってについてのそのような見解を、インターネットの起源、特にワールドワイドウェブ自体にまで遡ることができる。マルコフ(\protect\hyperlink{ref-markoff_what_2005}{2005})は、インターネットの開発を、60年代の反独裁的、自由主義的な１９６０年代のカウンターカルチャーにまでさかのぼって追跡しています。これは、地理的な境界から切り離された「サイバースペース」としてのインターネットとWWW上の思想をもたらしました。

ばるぼらとさやわか(\protect\hyperlink{ref-barubora_eng:_2017}{2017})によるとそれもまた、１９８０年代に西海岸思想またはカリフォルニア思想として、技術関連の雑誌を通じて配布されました。しかし、その対照的に、ポピュリストの考えを持っている言説は、右翼ポピュリズムのための繁殖地であり、ネット右翼が広がるカウンター・イデオロギーとのは新ナショナリズムである。東浩紀(\protect\hyperlink{ref-azuma_otaku:_2001}{2001})とばるぼら・さやわか(\protect\hyperlink{ref-barubora_eng:_2017}{2017})は日本におけるインターネットまたはWorld
Wide
Webの発展とアニメやビデオゲームのサブカルチャー（いわゆるオタク族）の結びきは小さくないという。さらに、東浩紀は、日本のナショナリズムは生き残ってくるのにオタク化されたと指摘している。これはアドルノとホルクハイマーの文化産業の理論（すなわち、ヘゲモニー的イデオロギーの合意に達するための消費物化される文化の使用）と重なることとも言える。そして、そのサブカルチャーに集中する自民党の「クールジャパン」の国主催のソフトパワー（また、麻生太郎を自称オタク、あるいは安倍晋三によるネット右翼とオタク文化が集まる「ニコニコ」の使用）はさらにその役割を果たしているのではないだろうか。

第四章は、ネット右翼が広まっている「カウンター・ヘゲモニー的イデオロギー」いくつかの主要なインターネットプラットフォームを対象とした混合研究法のコンテンツ分析である。そのために、本章はメディア学者のマクルーハンの「メディアはメッセージである」の立場から始まる。ただメッセージ（情報）のコンテンツだけではなく、メディア（情報媒体）そのものもがまたメッセージである。要するに、メッセージの内容は、そのメッセージを含むメディアにより解釈も変わる。すなわち本章では、第三章に挙げた「インターネットの発展の背景に隠されるイデオロギー」とメディア（この場合、SNSやインターネットプラットフォーム）の構造の影響力を両方考慮に入り、分析を行う。いわゆる「まとめサイト」は、２ちゃんねるで人気のあるトピックのコンテンツを収集し、自分のブログまたはTwitterなどのSNSを通じて配信する。

それらのまとめサイトはしばしば営利を目的として広告に頼っているので、２ちゃんねるのユーザーが抗議として「嫌儲」という、営利目的でコンテンツが収集できない部分（いわゆる板）を設立し、自分のアイデンティティとコミュニティーの構造ができたこととも言える。それでも、特に保守的な傾向が高いまとめサイトでは、\footnote{例：「保守速報」、「もえるあじあ」、「
  キムチ速報」や「笑韓ブログ」}オーナーが慎重に選択されたネット右翼的なコンテンツを世論（いわゆる「ネットの声」）とする件は少なくないとも言える。ただし、まとめサイトの到達範囲を過小評価してはいけなく、またこの章で示すように、数百万人ものインターネットユーザーが日本語版のインターネット外でも（日本のソフトパワーのもとに）英語などでアクセスできる可能性も明らかにした。\footnote{他人がそれらのユーザーの2ちゃんねるでの書き込みを利用して金儲けすることが嫌うことをしみ示す。ネット右翼と繋がる「嫌韓」に言及。}

さて、日本および世界で最も使用されているサイト上位１０の一つであるユーザーコンテンツに基づくウィキペディアでも、ネット右翼と２ちゃんねるの影響が明確に見える。本章は、日本語版のウィキペディアのデータベース最先端のコピーをもとに、格記事のリビジョン（改訂）の総数、リビジョンの中の取り消し（いわゆるrevert）の総数、とその記事の「論争レベル」（本章では、リビジョン数を取り消し数で割ったもの）を計算した。リビジョン数、取り消し数、および「論争レベル」に基づき、全３カテゴリー上位５０の記事は主にサブカルチャー（今更ポップカルチャーとも言える）のトピックに関連する。\footnote{具体的には、「ワンピース」というアニメとアイドル文化の「AKB48」に関連するトピックが多かった。詳細はテーブル\ref{fig:anon-wiki}}

さらに、ウィキペディアの共同創始者であるジミー・ウェールズも、日本語版のウィキペディアにポップカルチャー関連のトピックと他のトピックとの間に明確な格差があると指摘した(Cohen
\protect\hyperlink{ref-cohen_wikipedia_2009}{2009})。その上、ウィキペディアの匿名の変更数が世界平均をはるかに超えているという事実も、\footnote{詳細はテーブル\ref{tab:50expanded}}２ちゃんねるとの重複を示唆していないのだろうか。それでも、取り消し数が高いカテゴリーと「論争レベル」が高いカテゴリー両方でもサブカルチャーに関係ない記事がある。特に「論争レベル」が高いカテゴリーでは、「南京事件」（第１位）、「ネット右翼」（第２位）と、「日本」（第３位）\footnote{他は例えば、「安倍晋三」（第１１位）、「鳩山由紀夫」（第１３位）、「中華民国」（第１６位）、「金妍兒」（第１８位）、「在特会を許さない市民の会」（第１９位）、「在日韓国・朝鮮人」（第２１位）や「朝日新聞」（第２６位）である。}が際立っている。\footnote{荒らし行為の恐れが高い記事が管理者以外保護できない場合もある。}その中で小グループのウィキペディアユーザーがさまざまな成功を収めて記事のトーンを変更しようとする現象があり、明らかになったのは中立性を保護するユーザーもネット右翼の傾向があるユーザーも、２ちゃんねるとの関連が少なくないことである。さらに、特にネット右翼の傾向があるユーザーはサブカルチャーの記事でも活動し、日本語版だけではなく、英語版のウィキペディアでも変更しようとする傾向が見える。

しかし、同じ２ちゃんねるでは、上記に述べた「嫌儲」の「板」を含む、\footnote{他は、元々野球に関する「なんJ」または、韓国に関する「ハンJ」。}ネット右翼を批判するコミュニティーも明確に存在する。それらにおける政治的な理想にもかかわらず、明らかなのは、北田(\protect\hyperlink{ref-kitada_eng:_2005}{2005})がおしゃる通りそのコミュニティーにおける「アイロニー」である。そのコミュニティは、「ネトウヨBAN祭り」を始め、要するにTwitterやYoutubeなどのさまざまなプラットフォームの技術方的な法を利用し、数千のアカウント、数十万のメッセージやビデオを報告し、それらを「不適切な」嫌いな発言として削除させる。

今後の課題は、ネット右翼と関連されるプラットフォームの技術的側面とそのプラットフォームで感じられる共同体意識の間の関係をさらに調査することである。また、この調査を、特に韓国と中国でのサイバーナショナリズムの表現にも拡張すること。それらのサイバーナショナリスト（すなわち、中国と韓国の「ネット右翼」）はまた、日本のネット右翼の「嫌韓中」の形成に重要な役割を果たすことも言える。
...
associated with several other white-nationalist attacks.\footnote{An
  ...
  sub-culture elements (Collins and Blankstein
...
ostracism.\footnote{A common tactic on these forums is to antagonize and
  ...
  \emph{Zainichi}' (在日認定, \emph{zainichi nintei}) is used to refer
...
phenomenon of Netto-Uyoku in relation to social media on the Internet,
to the so-called ACM real-life protests and to the LDP. It further
suggested that the Netto-Uyoku adhere ideologically to a form of
right-wing populist nationalism (what this paper understands under
neo-nationalism) that does not just take place on the Internet, but is
further shaped by it as well. In the first chapter we've further
suggested that to be a global phenomenon, of which we view the
Netto-Uyoku as but one localized instance. Although this paper has so
far freely used concepts as ideology, populism and nationalism, these
terms are due to their over-inflation in usage at an increasing risk of
becoming reduced to trending political abstractions. Based on the
previous two chapters this chapter builds the theoretical groundings
through which we can interpret the underlying logics of
...
without a set of preconceived values, and following Mannheim's Paradox,
...
Napoleon's attack of the French ``ideologues'' as, in Bo Stråth's words
(\protect\hyperlink{ref-mudde_oxford_2013}{2013}, 22), ``unrealistic
escapism and philosophical reverie,'' ideology has since gone through
several shifts in meaning. From a classical Marxist view, as interpreted
by Eagleton (\protect\hyperlink{ref-eagleton_ideology:_1991}{1991}),
ideology too represented a false or misleading awareness of the human
situation. Ideology was however to be understood as an instrument of
those in control of the means of production. That is to say,
steering---whether intentional or not---the economically subservient
class away from a scientific, objective reality (and hence from what is
in the best interests of the dominated class) with a \emph{false
consciousness}, of one's ability to self-identify as an economic class
and express a political will. Hence maintaining the equilibrium this
mode of production.\footnote{Summed up in the first chapter of Marx'
  \emph{Das Kapital} as ``Sie wissen das nicht, aber sie tun es,'' or in
  English, ``They do not know it, but they do it.''} In other words,
classical Marx' materialist theory places ideology as a superstructure
in contrast to reality within an economic, dialectic
basis-superstructure relationship. The dominant ideology is tied
directly to the base, the mode of production, and visa-versa. On the
precondition of being universally applicable, one could then, for
example, view the Japanese \emph{kokutai} (国体) notion or
state-Shintoism to be ideological means for morally justifying
...
of a Japanese \emph{bourgeoisie}),\footnote{In \emph{The Japanese
  Economy}, Flath (\protect\hyperlink{ref-flath_japanese_2005}{2005})
  refers to the \emph{Zaibatsu} as ``at best a kind of \emph{petite
  bourgeoisie} (\protect\hyperlink{ref-flath_japanese_2005}{2005}, 75).
  Miwa and Ramseyer (\protect\hyperlink{ref-miwa_fable_2010}{2010}) in
  polemic fashion dismisses the \emph{Keiretsu} and \emph{Zaibatsu}
  ...
  ``populist journalists'' (Miwa and Ramseyer
...
Japan as \emph{nishikaigan shisō} 西海岸思想 or \emph{Karuforunia shisō}
カリフォルニア思想 (West Coast Thought or California Thought): an
...
Cool Japan is further proven by the high percentage of articles and
edits devoted to popular culture topics like Japanese animation and idol
formations. Furthermore, in a \emph{New York Times} interview, Wikipedia
co-founder Jimmy Wales himself asserted that about 80 percent of
Japanese Wikipedia articles were devoted to pop culture (Cohen
...
with my hypothesis of populist neo-nationalism becoming the hegemonic
ideology during the crucial years of 2009 - 2011. Moreover, due to the
