...
**Figure \ref{fig:genkifuji}**

Fuji Genki, a conservative online voice associated with the Sunrise Party of Japan and Japan Innovation Party, for example, is an adapter of the Internet and social media for such purposes. In his *nihonjin ga shiranai Amerika no hon'ne* 日本人が知らないアメリカの本音 ("The real intent of America, unknown to the Japanese"), he summarizes his thought on the Internet as: "With the advancement of an Internet-focused IT industry, humanity's creativity will evolve dramatically, and not only will life become prosperous, but an ideal democratic society will be realized as well." (「インターネットを中心とするIT技術が進歩するにしたがい、人類の創造性は格段に進化していき、生活が豊かになるのはもちろん、理想的なデモクラシー社会が実現する」).

He is another frequent speaker at the conservative online news outlet Toranomon News, and with 14,900 subscribers on his main account has published videos on Youtube both in English and Japanese on as well as on accounts as Yamatotube2, チャンネルくらら and 保守論客チャンネル+.
...
\begin{figure}[!htb]
  ...
  \end{subfigure}
  \caption{Screenshot of Fuji Genki's English homepage}\label{fig:genkifuji}
\end{figure}
...
[^38]: In another interesting intersection, Hiroyuki Nishimura has since lost ownership of 2channel to Jim Watkins (owner of the extreme right-wing 4chan spin-off 8chan) [@silverman_meet_2017] and in turn Hiroyuki Nishimura himself became owner of 4chan. 
[^101]: Whereas 2channel was in 2017, a decade after that report, still the 18th most visited website in Japan [@poppe_digitaal_2017, p.15], in its current state as 5channel it is has since dropped to \nth{43} position
